...
@IBDesignable
public class VibaTextField: UITextField {
    ...
    public var dtLayer = CALayer()
    public var floatPlaceholderColor = Colors.floatPlaceholderColor.value
    public var floatPlaceholderActiveColor = UIColor.black
    ...
    public var borderColor = Colors.textFieldBorderColor.value {
        didSet {
            switch dtborderStyle {
    ...
    override public func layoutSubviews() {
        ...
        lblFloatPlaceholder.frame = CGRect(x: xVal, y: lblFloatPlaceholder.frame.origin.y,
